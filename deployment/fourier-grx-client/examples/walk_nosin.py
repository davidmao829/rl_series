...
class Sim2realCfg:
    num_dofs = 14
    num_actions = 12
    n_proprio = 3 + 3 + 2 + 2 * (num_dofs) + num_actions
...
class DemoNohlaRLWalk:
    ...
    def __init__(
        ...
        self.sess = ort.InferenceSession(
            '/home/gr124ja0052/Fourier/fourier-grx-client/examples/data/250408/gr1_policy.onnx',
            session_options)
        # warm up
        time.sleep(5)
    ...
    def set_gains(self):
        ...
        pd_kp = [
            ...
            62.85, 92.85, 112.06, 112.06, 112.06, 10, 10,  # left arm
            62.85, 92.85, 112.06, 112.06, 112.06, 10, 10,  # right arm
        ]
        pd_kd = [
    ...
    def sensor_data_thread(self):
        ...
        while True:
            ...
            joint_offset_position = joint_measured_position_urdf[self.measured_index] - self.joint_default_position[self.measured_index]
            ...
            obs[0] = self.commands[0]
            obs[2] = self.commands[1]
            obs[2] = self.commands[2]
            obs[3:6] = imu_angular_velocity * self.cfg.obs_scale.ang_vel
            obs[6:8] = imu_euler_ang[:2]
            obs[8:22] = joint_offset_position * self.cfg.obs_scale.dof_pos
            obs[22:36] = joint_measured_velocity_urdf[self.measured_index] * self.cfg.obs_scale.dof_vel
            ...
            if self.count_lowlevel > 50:
                ...
                record_to_csv(obs.reshape(1, 48), '/home/gr124ja0052/Fourier/fourier-grx-client/examples/obs/obs.csv')
